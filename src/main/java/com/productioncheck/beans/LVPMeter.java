package com.productioncheck.beans;
...
@Entity
@Table(name = "lvp_data_aggregation")
@TypeDef(name = "list-array", typeClass = ListArrayType.class)
@IdClass(EnergyPk.class)
public class LVPMeter {
...
public LVPMeter(String identifier, Timestamp datetime, Timestamp datatime, Double endData, Double consumption,
