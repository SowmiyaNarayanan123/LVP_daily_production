...
import com.productioncheck.repository.WaterMeterDataAggregationRepository;
...
@RestController
@RequestMapping("/Watermeter-data")
public class WaterMeterController {
	 @Autowired
	    private MeterDataService meterService;

	    @Autowired
	    private WaterMeterDataAggregationRepository repo;

	    @PostMapping("")
	    public ResponseEntity<Page<WaterMeter>> fetchData(
	        ...
	        Page<WaterMeter> result = repo.findFilteredData(
	                service.getColony(),
