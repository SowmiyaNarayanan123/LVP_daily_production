...
import com.productioncheck.repository.LVPSubmetersRespository;
import com.productioncheck.service.MeterDataService;

@RestController
@RequestMapping("/Lvpsubmeter-data")
public class LVPSubmeterController {
	 @Autowired
	    private MeterDataService meterService;

	    @Autowired
	    private LVPSubmetersRespository repo;

	    @PostMapping("")
	    public ResponseEntity<Page<LVPSubMeter>> fetchData(
	        ...
	        Page<LVPSubMeter> result = repo.findFilteredData(
	                service.getColony(),
